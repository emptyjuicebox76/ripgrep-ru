...
Обратите внимание, что в последнее время в ripgrep появились несколько важных
...
Я не знаю как исправить, и у меня нет времени их исправлять. Таким образом,
...
перекодировании UTF-16. Поскольку для этого требовались нестабильные функции,
...
файлом. Статическое связывание можно принудительно выполнить даже при наличии
